...
// 14. What is out?  Meaning where is the text inside dataField going
                out.println(dataField.getText());
                   String response;
                try {
// 15. What is in?  Meaning where is the string going into response coming from?
...
// 16.  What is the initial welcoming message?
        for (int i = 0; i < 3; i++) {
