...
public class TicTacToeServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            while (true) {
                Game game = new Game();
// 19. When this program starts what will cause it to go from this line (‘X’) to the following line (‘O’)?
                Game.Player playerX = game.new Player(listener.accept(), 'X');
// 20. What will cause it to go from this line (‘O’) to the rest of the code?
...
class Game {
     ...
     * client.
     */
// 22.  What does it mean that this method is synchronized?    Why is this important?
